<%@ Page Title="" Language="C#" MasterPageFile="~/CompagnieVoyage.Master" AutoEventWireup="true" CodeBehind="superAdmin.aspx.cs" Inherits="AT7_AT8_projet.WebForm6" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row">
            <div class="col-md-12">
              ...
              <div class="container">
                  <h2>Liste des Administrateur et des Membres</h2>
                 ...
                 <!--Registered -->
                    <div class="text-center w-100">
                        <p class="text-muted font-weight-bold">
                            <a href="gestionAdminMembre.aspx" class="text-primary ml-2">Gérer les comptes </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:HyperLink ID="hlTable" runat="server" Text="" NavigateUrl=""></asp:HyperLink>
                        </p>
                    </div>
