...
namespace AT7_AT8_projet
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        {
            cn_ComVoyage.Open();
            SqlCommand cmd = new SqlCommand($"update membre set matricule='{ matricule.Text}', nom ='{Nom.Text}',prenom='{Prenom.Text}',service_ ='{DdlService.Text}',mail ='{Email.Text}' where pseudo ='{Session["pseudo"]}'",cn_ComVoyage);
            cmd.ExecuteNonQuery();
            cn_ComVoyage.Close();
